...
%
\ArtDerArbeit{Integrationsseminar} 
\TitelDerArbeit{Vulnerabilities in Open Source Frameworks und Libraries}
...
\WissBetreuer{Prof. Dr. Michael Eichberg}
\FirmenBetreuer{}
\Bearbeitungszeitraum{17.02.2025 - 07.04.2025}
...
%
% Einleitung
\input{textPages/einleitung}
\cleardoublepage

\input{textPages/schwachstellen}
\cleardoublepage

\input{textPages/ursachen}
\cleardoublepage

\input{textPages/strategien}
\cleardoublepage
% Fazit und Ausblick
\input{textPages/fazit}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
